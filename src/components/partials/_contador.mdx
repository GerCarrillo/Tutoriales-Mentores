...
de los estudiantes en los foros del curso.

Esta información te permitirá realizar un diagnóstico oportuno de las actividades
de los estudiantes para que tomes las medidas necesarias para evitar el fracaso estudiantil.
...
Se trata de dos páginas de la Plataforma que ofrecen un panorama completo y organizado
de la actividad de cada estudiante en la materia, tanto en sus **envíos
de tarea** como en las **participaciones en foros**. **Su principal objetivo es
...
- **Columnas:** *Información por número de envío.* Cada una de estas columnas representa, ya sea el status del envío de la actividad del alumno, o el número de comentarios en el foro.
	...
	- **Envío de Tarea.** Los íconos indican el status del último envío de la tarea:
		- ***Tarea satisfactoria*** 👍🔵 (mano con pulgar arriba en color azul).
		- ***Tarea insatisfactoria*** 👎🟥 (mano con pulgar abajo en color rojo).
		- ***Tarea pendiente de evaluar*** 💬❔◼️ (ícono de diálogo con un signo de interrogación dentro en color negro).
		- ***Tarea pendiente de ser enviada*** 💬❔🩶 (ícono de diálogo con un signo de interrogación dentro en color gris).
		- ***Tarea reprobada*** 🟥🟥 (ícono de documento en color rojo).
		
	![vistacal](./img/imgvistacal.png)

	- **Comentarios de Foro.** Las celdas indican la cantidad de comentarios o participaciones que el estudiante ha realizado de ese foro en particular.
...
<VideoIntro title="Acceso al correo institucional" videoUrl="https://www.youtube.com/embed/lQhMvA-3Y_A" />