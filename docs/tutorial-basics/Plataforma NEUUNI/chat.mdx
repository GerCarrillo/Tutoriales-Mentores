...
## Contacta a tus alumnos en la plataforma

Entendemos que en un entorno virtual puede ser difícil la comunicación entre estudiantes y docentes. Es por eso 
que, dentro de la plataforma, encontrarás un espacio diseñado para conversar con tus alumnos.
...
Para buscar al usuario, dirígete a la barra de búsqueda que aparece en la imagen y escribe el nombre
...
¡Listo! Con estos sencillos pasos habrás establecido comunicación con tus alumnos. Recuerda que esta funcionalidad 
es una herramienta muy útil para mantenerte en contacto.